...
const heroSection = () => {
  return (
    <div className="pl-5 mt-15">
      <div>
        <div className="md:flex md:gap-7 lg:gap-18">
          <h2 className="text-[33px] font-semibold mb-7 max-w-[90%] lg:text-5xl md:max-w-[65%] md:text-4xl">
            Store.{" "}
        ...
        <div className="mt-15 ml-3 flex items-center overflow-x-scroll gap-5 md:gap-13 no-scrollbar pr-5">
          <div className="flex flex-col w-22 items-center gap-3">
            <Image
              width={88}
              height={88}
              className="min-w-22 md:min-w-28"
