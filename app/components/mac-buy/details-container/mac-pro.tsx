...
const MacProImages = [
  "/apple-site/buy/mac/all-models/mac-pro/main.jpeg",
  "/apple-site/buy/mac/all-models/mac-pro/side.png",
  "/apple-site/buy/mac/all-models/mac-pro/inside.png",
  "/apple-site/buy/mac/all-models/mac-pro/back.png",
  "/apple-site/buy/mac/all-models/mac-pro/top.png",
  "/apple-site/buy/mac/all-models/mac-pro/final.jpeg",
];
          ...
          <div className="mt-10 flex flex-col justify-center">
            ...
            <div className="flex flex-col justify-center">
              <h2 className="max-w-[20rem] mx-auto mt-6 text-sm text-center mb-5">
                From ₹66221.00/mo.per month with EMI◊◊,or ₹729900.00‡
              </h2>
              <Link
              ...
              <div className="mx-auto">
                ...
                <div className="px-5 mt-10">
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="w-[80%] font-Sf-semibold text-lg">
                      Supercharged by M2 Ultra, with a 24‑core CPU and up to
                      76‑core GPU
                    </h2>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    <Image
                      ...
                      src="/apple-site/buy/mac/all-models/menu-bar.png"
                      alt="sound"
                    />

                    <h2 className="w-[80%] font-Sf-semibold text-lg">
                      PCIe gen 4 expansion slots provide up to twice the
                      bandwidth for specialised workflows
                    </h2>
                  </div>
                  <div className="w-full h-[1px] bg-black/20 mt-4 mb-4"></div>
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <h2 className="w-[80%] font-Sf-semibold text-lg">
                      Connect all your accessories with high-performance I/O,
                      including eight Thunderbolt 4, two HDMI and two 10Gb
                      Ethernet ports
                    </h2>
                  </div>
                  <div className="w-full h-[1px] bg-black/20 mt-4 mb-4"></div>
                  <div className="flex items-center gap-2">
                    <Image
                      ...
                      src="/apple-site/buy/mac/all-models/slider.png"
                      alt="slider"
                    />

                    <h2 className="w-[80%] font-Sf-semibold text-lg">
                      Runs cool and quiet, even under intensive workloads
                    </h2>
                  </div>
                  <div className="w-full h-[1px] bg-black/20 mt-4 mb-4"></div>
                  <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="w-[80%] font-Sf-semibold text-lg">
                      Comes with Magic accessories. Complete your setup with Pro
                      Display XDR
                    </h2>
                  </div>
                </div>
                <Link
                  ...
                  href=""
                >
                  Explore Mac Pro further <ChevronRight size={18} />
                </Link>
              </div>
            </div>
