          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-10 flex flex-col justify-center">
              ...
              <div className="flex mt-5 justify-center gap-5">
                <h2 className="bg-black/10 px-6 py-2 rounded-full">13”</h2>
                <h2 className="bg-black/10 px-6 py-2 rounded-full">15”</h2>
              </div>
              ...
              <Link
                className="bg-blue-500 text-center mx-auto max-w-[4rem] rounded-full text-sm text-white px-4 py-2"
                href=" "
              >
                Buy
              </Link>
                ...
                <div className="px-5 mt-10">
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="w-[80%] font-Sf-semibold text-lg">
                      Lightweight and less than two centimeters thin, so you can
                      take MacBook Air anywhere you go
                    </h2>
                  </div>
            ...
            <div className="w-full px-5 pb-[20rem] pt-10 bg-[#f5f5f5]">
