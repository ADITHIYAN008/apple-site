...
const MacAirImages = [
  "/apple-site/buy/mac/all-models/imac/main.png",
  "/apple-site/buy/mac/all-models/imac/front.png",
  "/apple-site/buy/mac/all-models/imac/back.png",
  "/apple-site/buy/mac/all-models/imac/left.png",
  "/apple-site/buy/mac/all-models/imac/stand.png",
  "/apple-site/buy/mac/all-models/imac/final.png",
];
                ...
                <div className="px-5 mt-10">
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="w-[80%] font-Sf-semibold text-lg">
                      An all-in-one desktop, iMac is strikingly thin, comes in
                      seven vibrant colours and complements any room
                    </h2>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="w-[80%] font-Sf-semibold text-lg">
                      The powerful M4 chip with an up to 10‑core CPU and up to
                      10‑core GPU keeps things running smoothly
                    </h2>
                  </div>
                  <div className="w-full h-[1px] bg-black/20 mt-4 mb-4"></div>
                  <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="w-[80%] font-Sf-semibold text-lg">
                      The 60.96 cm (24″) 4.5K Retina display features 500 nits
                      of brightness and supports up to 1 billion colours, with a
                      nano-texture option for reduced glare in very bright
                      settings²
                    </h2>
                  </div>
                  <div className="w-full h-[1px] bg-black/20 mt-4 mb-4"></div>
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="w-[80%] font-Sf-semibold text-lg">
                      A 12MP Center Stage camera, studio-quality mics and six
                      speakers with Spatial Audio help you stay perfectly framed
                      and sounding great
                    </h2>
                  </div>
                  <div className="w-full h-[1px] bg-black/20 mt-4 mb-4"></div>
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <h2 className="w-[80%] font-Sf-semibold text-lg">
                      Colour-matched Magic Mouse and Magic Keyboard included
                    </h2>
                  </div>
                </div>
                <Link
                  ...
                  href=""
                >
                  Explore iMac further <ChevronRight size={18} />
                </Link>
              </div>
            </div>
