  ...
  return (
    <div className="bg-white">
      ...
      <div className="text-center mt-7 tracking-wide">
        ...
        <div className="border  flex focus-within:border-2 focus-within:border-blue-600 items-center px-2 py-3 rounded-2xl w-auto mx-10 mt-5">
        ...
        <h2 className="flex text-blue-500 justify-center tracking-wide mt-5 items-center">
        ...
        <div className="mt-5 bg-[#f5f5f7]">
          ...
          <div className="px-5 flex gap-3 no-scrollbar overflow-scroll">
            <div className="w-[20rem] min-w-[20rem] shadow-2xl/10 min-h-[21rem] rounded-2xl bg-white">
              <div className="bg-black w-full h-auto rounded-t-2xl">
                <Image
                  width={200}
                  height={200}
          ...
          <div className="px-5 pb-20">
            ...
            <div className="w-[22rem]  mt-10 min-w-[22rem] shadow-2xl/10 min-h-[34rem] rounded-2xl bg-white">
              <div className="w-full rounded-t-2xl h-[15rem] bg-black">
                <Image
                  width={200}
                  height={200}
              ...
              <div className="pt-7 px-5">
                ...
                <h2 className="flex items-center text-lg justify-center text-blue-500 mt-3">
                  See what yout device is worth <GoChevronRight />
                </h2>
                <h2 className="flex mt-7 items-center text-lg justify-center px-5 text-blue-500">
                  How to prepare your device for trade-in
                </h2>
              </div>
            </div>
            <div className="w-[22rem] px-5 mt-7 min-w-[22rem] shadow-2xl/10 min-h-[18rem] pt-10 rounded-2xl bg-white">
              ...
              <h2 className="flex items-center text-lg justify-center text-blue-500 mt-4">
            ...
            <div className="w-[22rem]  mt-8 min-w-[22rem] shadow-2xl/10 min-h-[34rem] rounded-2xl pt-10 bg-white">
              ...
              <div className="pt-18 px-5">
                ...
                <h2 className="flex mt-5 items-center text-lg justify-center px-5 ">
                  Purchse Apple devices and accessories within our stores with
                  Apple Store Gift Card.
                </h2>
                <h2 className="flex items-center text-lg justify-center text-blue-500 mt-2">
            ...
            <div className="w-[22rem]  mt-7 min-w-[22rem] shadow-2xl/10 min-h-[27rem] rounded-2xl bg-white">
              <div className="w-full rounded-t-2xl h-[15rem] bg-black">
                <Image
                  width={200}
                  height={200}
            ...
            <div className="w-[22rem]  mt-3 min-w-[22rem] shadow-2xl/10 min-h-[29rem] rounded-md bg-white">
              <div className="w-full rounded-t-md h-[15rem] bg-black">
                <Image
                  width={200}
                  height={200}
              ...
              <div className="pt-10 pl-8 text-left pr-8">
                ...
                <h2 className="font-Sf-semibold text-xl pr-10 mt-2">
                  Explore Apple Intelligence in a free session at your Apple
                  Store.
                </h2>
                <h2 className="flex items-center text-lg  text-blue-500 mt-3">
                  Sign up <GoChevronRight />
                </h2>
              </div>
            </div>
            <div className="w-[22rem]  mt-5 min-w-[22rem] shadow-2xl/10 min-h-[29rem] rounded-md bg-white">
              <div className="w-full rounded-t-md h-[15rem] bg-black">
                <Image
                  width={200}
                  height={200}
              ...
              <div className="pt-10 pl-8 text-left pr-5">
                ...
                <h2 className="font-Sf-semibold text-xl pr-16 mt-2">
                  Get ready for fun at Apple Camp, free for kids ages 6-10.
                </h2>
                <h2 className="flex items-center text-lg  text-blue-500 mt-3">
